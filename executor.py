...
class Executor:
    ...
    def train_one_epoch(self):
        ...
        for i, batch in enumerate(self.train_loader, start=1):
            ...
            metric1 = Metric(si_snri.item(), sdri.item())
            logger.log(metric1, progress=i / num_batches, force=i == num_batches)
    ...
    def _test(self, loader):
        ...
        metric1 = Metric(total_si_snri.item() / num_samples, total_sdri.item() / num_samples)
        return metric1